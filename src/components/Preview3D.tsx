...
export default function Preview3D({ scene }: { scene: THREE.Group }) {
  ...
  return (
    <div className="preview-pane bg-panel flex min-h-0 flex-col overflow-auto p-[14px]">
      <div className="mb-[10px] flex items-center justify-between">
        <h2 className="text-muted m-0 text-[12px] tracking-widest uppercase">
          3D Preview
        </h2>
        <div className="flex items-center gap-[10px]">
          <label className="text-muted flex items-center gap-[6px] text-[12px] whitespace-nowrap">
            <input
              type="checkbox"
              checked={wireframe}
